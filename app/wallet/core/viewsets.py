...
class ExGenericAPIView(rf_generics.GenericAPIView):
    """
    Extends feature to add parent_user object to request object
    """


class ExGenericViewSet(ExGenericAPIView, rf_viewsets.GenericViewSet):
    """
...
class ExModelViewSet(rf_viewsets.ModelViewSet, ExGenericViewSet):
    """
